...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&9K8RthRE' : process.env.SESSION_ID, // put your session id || ඔයාගෙ සෙසන් එක දාන්න...😌❤
...
SUDO: process.env.SUDO === undefined ? '94728591962' : process.env.SUDO,
